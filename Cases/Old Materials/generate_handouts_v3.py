"""
Generate Word Document Case Study Handouts for MGMT298D - Version 3
...
VERSION 3 CHANGES:
- Narrowed to 2 cases per week (16 total cases)
- Replaced Wikipedia sources with official/academic sources
...
# ============================================
# CASE DATA - 2 Cases Per Week (16 Total)
# All sources verified, no Wikipedia
# ============================================
...
cases = [
    ...
    # WEEK 1A: ZILLOW
    {
        ...
        "primary_source": "https://www.gsb.stanford.edu/insights/flip-flop-why-zillows-algorithmic-home-buying-venture-imploded",
        "teaching_tips": [
    ...
    # WEEK 1B: AIRBNB
    {
        ...
        "primary_source": "https://medium.com/airbnb-engineering/learning-market-dynamics-for-optimal-pricing-97cffbcc53e3",
        "teaching_tips": [
    ...
    # Cases: Capital One, Healthcare FDA
    # ============================================
    ...
    # WEEK 2A: CAPITAL ONE
    {
        ...
        "primary_source": "https://d3.harvard.edu/platform-rctom/submission/machine-learning-in-credit-assessment-at-capital-one/",
        "teaching_tips": [
    ...
    # WEEK 2B: HEALTHCARE FDA
    {
        "week": 2,
        "topic": "Tree-Based Predictions",
        "id": "Week2B_Healthcare",
        ...
        "primary_source": "https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2841066",
        "teaching_tips": [
    ...
    # ============================================
    # WEEK 3: CLUSTERING & COLLABORATIVE FILTERING
    # Cases: Spotify/Netflix, JPMorgan COIN
    # ============================================
    ...
    # WEEK 3A: SPOTIFY/NETFLIX
    {
        ...
        "primary_source": "https://music-tomorrow.com/blog/how-spotify-recommendation-system-works-complete-guide",
        "teaching_tips": [
    ...
    # WEEK 3B: JPMORGAN COIN
    {
        ...
        "primary_source": "https://www.abajournal.com/news/article/jpmorgan_chase_uses_tech_to_save_360000_hours_of_annual_work_by_lawyers_and",
        "teaching_tips": [
            "Good for discussing professional services automation",
            "Connects to broader workforce transformation discussion",
            "Connect to lecture: Unsupervised learning for pattern discovery",
    ...
    # WEEK 4A: UBER
    {
        ...
        "primary_source": "https://www.uber.com/blog/reinforcement-learning-for-modeling-marketplace-balance/",
        "teaching_tips": [
    ...
    # WEEK 4B: ALPHAGO
    {
        ...
        "primary_source": "https://www.nature.com/articles/nature16961",
        "teaching_tips": [
    ...
    # Cases: AlphaFold, DeepMind Data Centers
    # ============================================
    ...
    # WEEK 5A: ALPHAFOLD
    {
        ...
        "primary_source": "https://deepmind.google/discover/blog/alphafold-a-solution-to-a-50-year-old-grand-challenge-in-biology/",
        "teaching_tips": [
    ...
    # WEEK 5B: DEEPMIND DATA CENTERS
    {
        ...
        "primary_source": "https://deepmind.google/discover/blog/deepmind-ai-reduces-google-data-centre-cooling-bill-by-40/",
        "teaching_tips": [
    ...
    # WEEK 6A: TESLA
    {
        ...
        "primary_source": "https://www.thinkautonomous.ai/blog/how-tesla-autopilot-works/",
        "teaching_tips": [
    ...
    # WEEK 6B: WAYMO
    {
        ...
        "primary_source": "https://waymo.com/blog/2024/10/introducing-emma",
        "teaching_tips": [
    ...
    # WEEK 7A: KLARNA
    {
        ...
        "primary_source": "https://tech.co/news/klarna-reverses-ai-overhaul",
        "teaching_tips": [
    ...
    # WEEK 7B: MORGAN STANLEY
    {
        "week": 7,
        "topic": "Transformers & LLMs",
        "id": "Week7B_MorganStanley",
        ...
        "primary_source": "https://www.cnbc.com/2023/09/18/morgan-stanley-chatgpt-financial-advisors.html",
        "teaching_tips": [
    ...
    # ============================================
    # WEEK 8: GENERATIVE AI & AGENTS
    # Cases: GitHub Copilot, John Deere
    # ============================================

    # WEEK 8A: GITHUB COPILOT
    {
        "week": 8,
        ...
        "primary_source": "https://github.blog/news-insights/research/research-quantifying-github-copilots-impact-on-developer-productivity-and-happiness/",
        "teaching_tips": [
    ...
    # WEEK 8B: JOHN DEERE
    {
        ...
        "primary_source": "https://agfundernews.com/breaking-exclusive-john-deere-acquires-see-spray-robotics-startup-blue-river-technology-305m",
        "teaching_tips": [
...
print(f"Total cases: {len(cases)} (2 per week)")
