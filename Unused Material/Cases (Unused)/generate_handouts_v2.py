"""
Generate PDF Case Study Handouts for MGMT298D - Version 3
UCLA Anderson - Science and Strategy of AI

Creates:
1. Student handouts (single page, compact layout)
...
def add_footer(canvas, doc, source_url):
    """Add source URL footer to each page"""
    canvas.saveState()
    canvas.setFont('Helvetica', 7)
    canvas.setFillColor(HexColor('#888888'))
    canvas.drawCentredString(letter[0]/2, 0.4*inch, f"Source: {source_url}")
    canvas.restoreState()

def create_student_handout(filename, week_num, week_topic, case_title, content_paragraphs, key_facts, questions, primary_source):
    """Create student-facing handout (single page, compact layout)"""
    ...
    # Divider
    story.append(HRFlowable(width="100%", thickness=1.5, color=UCLA_GOLD, spaceAfter=6))
    ...
    for para in content_paragraphs:
        if para.startswith('"') or para.startswith('"'):
            story.append(Paragraph(para, styles['QuoteText']))
        else:
            story.append(Paragraph(para, styles['CaseSummary']))

    # Discussion Questions (no key facts table)
    ...
    # Footer with primary source
    story.append(Spacer(1, 6))
    story.append(HRFlowable(width="100%", thickness=0.5, color=HexColor('#CCCCCC'), spaceAfter=3))
    story.append(Paragraph(f"Source: {primary_source}", styles['FooterText']))
...
cases = [
        ...
        "questions": [
            ...
            },
            {
                ...
                "notes": [
                    ...
                    "Sparse data = unreliable predictions",
    ...
    # WEEK 6A: TESLA
    {
        ...
        "key_facts": [
            ...
            ("FSD v12 code reduction", "~300,000 lines → ~2,000-3,000 lines"),
    ...
    # WEEK 7A: KLARNA
    {
        ...
        "key_facts": [
            ...
            ("Workforce reduction", "5,000 → 3,800 employees"),
    ...
    # WEEK 8A: MORGAN STANLEY
    {
        ...
        "content_paragraphs": [
            ...
            '"We have a knowledge base of over 100,000 documents and the idea is to bring that knowledge base—that differentiated intellectual capital—and put it together on top of the models of GPT-4," explained Jeff McMillan, head of analytics, data and innovation at Morgan Stanley wealth management. The goal: create "an ecosystem that\'s private to Morgan Stanley" making expert content available "24 hours a day 7 days a week virtually instantaneously."',
        ...
        "key_facts": [
            ...
            ("Document access improvement", "20% → 80%"),
