...
@router.post("/similarity", response_model=SimilarityResponse, tags=["Word Embeddings"])
...
@router.post("/analogy", response_model=AnalogyResponse, tags=["Word Embeddings"])
...
@router.get("/embedding_viz", response_model=EmbeddingVizResponse, tags=["Word Embeddings"])
...
@router.post("/train_classifier", response_model=ClassifierResponse, tags=["Transformers"])
...
@router.get("/compare_transformers", response_model=CompareTransformersResponse, tags=["Transformers"])
...
@router.get("/available_words", tags=["Word Embeddings"])
...
@router.get("/model_info", tags=["Transformers"])
