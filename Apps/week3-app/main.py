import os
"""
Week 3: Reinforcement Learning - Dynamic Pricing Application
...
app = FastAPI(
    title="Week 3: Reinforcement Learning - Dynamic Pricing",
...
def health_check():
    return {
        "status": "healthy",
        "application": "Week 3: Reinforcement Learning - Dynamic Pricing",
        "components": {
